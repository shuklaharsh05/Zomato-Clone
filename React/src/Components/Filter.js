...
class Filter extends React.Component {
    ...
    componentDidMount() {
        ...
        const { type } = q;
        //const { meal } = toString(type);
        //const meal = Number(type);    //to activate this send mealtypeID insteat of name from node
        //console.log(meal);
        ...
        return (
            <div>
                ...
                <div className="container mb-5">
                    ...
                    {mealtype ?
                        <h2 className="filter-heading mt-3"> {mealtype} Places </h2>
                        :
                                    ...
                                    <div className="results" onClick={() => this.handleDetailsPage(item._id)}>
                                        <div className="d-flex">
                                            <div className="lt-box">
                                                <img src="./img/Breakfast.png" className="img-fluid img-qs" alt='' />
                                            </div>
