        ...
        return (
            <div>
                    ...
                    <div className="position-absolute float-end" style={{ marginLeft: "50em" }}>
                        {!user ? (
                            ...
                            <form className="d-flex mt-2">
                                ...
                                <img className='img-fluid img-thumbnail circle' src={user.photos[0].value} alt='' />
                ...
                >
                    ...
                    <div>
                        <img src='https://static-00.iconduck.com/assets.00/google-icon-2048x2048-czn3g8x8.png' className='logo_google' alt='' />
